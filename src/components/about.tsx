      ...
      <section id="about" className="text-white py-20 px-5 mx-auto max-w-[1386px]">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex flex-col gap-8 w-full md:w-auto">
            {/* Experience Card */}
            <div className="glow-border bg-[#06131b] border border-cyan-500/40 rounded-3xl flex flex-col justify-center items-center w-full xl:max-w-[626px] md:max-w-[40vw] xl:h-[397px] h-[300px] text-center px-8 sm:px-16 md:px-28 leading-tight relative overflow-hidden light">
              <div className="glow-effect pointer-events-none" />
              <h1 className="text-6xl sm:text-[55px] xl:text-[80px] font-bold mb-4 sm:mb-8 z-10 relative">3+</h1>
              <p className="text-2xl sm:text-3xl xl:text-[48px] font-bold z-10 relative">Years Of Experience</p>
            </div>

            {/* Projects Card */}
            <div className="glow-border bg-[#06131b] border border-cyan-500/35 rounded-3xl flex items-center px-4 sm:px-6 xl:px-10 gap-4 xl:h-[166px] h-[140px] w-full xl:max-w-[626px] md:max-w-[40vw] relative light1 overflow-hidden">
              <div className="glow-effect pointer-events-none" />
              <div className="flex-shrink-0 w-[80px] h-[80px] xl:w-[100px] xl:h-[100px] border border-[#139bfd] rounded-full flex items-center justify-center glow-dot bg-black/30">
              ...
              <div>
                ...
                <p className="text-base xl:text-lg text-white opacity-80">30+ Projects Delivered</p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full md:w-[690px] space-y-6">
            <div>
              <h5 className="text-cyan-400 text-sm sm:text-base uppercase tracking-wider">
                ABOUT ME
              </h5>
              <h2 className="text-3xl sm:text-4xl xl:text-5xl font-bold mt-2">
                Engineering Scalable Solutions with Code & Intelligence
              </h2>
              <p className="mt-4 text-gray-300 leading-relaxed text-base xl:text-lg">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
              <div className="flex items-start gap-3 group">
                ...
                <span className="text-base xl:text-lg">End-to-End Web Application Architecture</span>
              </div>
              <div className="flex items-start gap-3 group">
                <div className="mt-1 w-2 h-2 rounded-full bg-cyan-400 glow-dot" />
                <span className="text-base xl:text-lg">Dynamic User Interfaces with Modern Frameworks</span>
              </div>
              <div className="flex items-start gap-3 group">
                <div className="mt-1 w-2 h-2 rounded-full bg-cyan-400 glow-dot" />
                <span className="text-base xl:text-lg">Intelligent Process Automation & Integration</span>
              </div>
              <div className="flex items-start gap-3 group">
                <div className="mt-1 w-2 h-2 rounded-full bg-cyan-400 glow-dot" />
                <span className="text-base xl:text-lg">Scalable APIs & Real-Time Data Systems</span>
              </div>
            </div>
          </div>
        </div>
