...
// More testimonials added, some avatars omitted to use initials fallback.
const testimonials = [
  {
    name: "Alice R.",
...
const Testimonials = () => {
  return (
    <section id="testimonials" className="py-20 bg-[#03101A] relative">
      <div className="max-w-[1520px] mx-auto px-2 sm:px-5">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-2 sm:mb-3 text-[#36ccfd] tracking-tight drop-shadow-xl">
          Testimonials
        </h2>
        <p className="text-[#bde3f5] text-center text-base sm:text-lg mb-7 sm:mb-12">
        ...
        >
          {testimonials.map((t, i) => (
            <SwiperSlide key={i}>
              <div
                className="relative bg-[#06131b]/90 border border-[#36ccfd2f] rounded-3xl px-6 py-10 sm:px-12 sm:py-12 md:px-14 md:py-14 lg:px-14 lg:py-12 shadow-2xl
                  group
                  transition-all duration-300 
                  hover:scale-[1.045]
                  hover:shadow-[0_20px_60px_0_#2bb7fc3f,0_0_22px_5px_#36ccfd58] 
                  hover:border-[#36ccfd]
                "
                style={{
                  minHeight: 320,
              ...
              >
                <div className="flex items-center mb-6">
                  <div className="flex-shrink-0 ">
                    <div
                      className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full bg-[#12334b] border-[3px] border-[#36ccfd88] flex items-center justify-center
                      overflow-hidden shadow-xl
                      group-hover:border-[#36ccfd] group-hover:scale-110 group-hover:shadow-[0_0_0_9px_#36ccfd2e]
                      transition-all duration-300"
                    >
                      {t.avatar ? (
                        <img
                  ...
                  <div className="ml-5">
                    <div className="font-semibold text-[#aee9fc] text-xl sm:text-2xl md:text-2xl lg:text-3xl drop-shadow mb-1">{t.name}</div>
                    <div className="text-[#3ed0ff] text-base sm:text-lg md:text-lg font-medium">{t.role}</div>
                  </div>
                </div>
                ...
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(ellipse at 65% 45%, #36ccfd33 0%, transparent 73%)",
                    filter: "blur(12px)",
                    zIndex: 0,
                  }}
                ></div>
      ...
      <style jsx global>{`
        ...
        .testimonial-swiper .swiper-pagination-bullet-active {
          opacity: 1;
          background: linear-gradient(90deg,#36ccfd 40%,#0097fc 90%);
          transform: scale(1.19);
          box-shadow: 0 2px 8px #38e8fd37;
        }
        ...
        .testimonial-swiper .swiper-button-prev {
          ...
          width: 44px;
          height: 44px;
          box-shadow: 0 0px 8px 0 #139bfd28;
          top: 49%;
        }
        .testimonial-swiper .swiper-button-next:hover,
        .testimonial-swiper .swiper-button-prev:hover {
          background: #36ccfd !important;
